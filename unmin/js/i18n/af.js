...
var ind = {
	...
	/* Geomap */
	"%geo-mapcontrol": "Map beheer",
	"%geo-zoomin": "Zoom in",
	"%geo-zoomout": "Zoem uit",
	"%geo-zoomworld": "Zoom mate kaart",
	"%geo-zoomfeature": "Zoom in op die element",
	"%geo-scaleline": "kaartskaal",
	"%geo-mouseposition": "Breedte-en lengteligging van die muis",
	"%geo-ariamap": "Kaart voorwerp. Die beskrywings van die kaart funksies is in die tabel hieronder.",
	"%geo-accessibilize": "<strong>Sleutelbord-gebruikers:</strong> Wanneer die kaart in fokus is, gebruik die pyltjie sleutels om die kaart en die plus en minus sleutels om te zoom om die pan. Die pyltjie sleutels om die kaart sal nie die pan wanneer dit aan die kaart mate vergrote.",
	"%geo-accessibilizetitle": "Instruksies: Kaart navigasie",
	"%geo-togglelayer": "Skakel die vertoning van die laag",
	"%geo-hiddenlayer": "Hierdie laag is tans weggesteek.",
	...
	"%geo-attributiontitle": "GeoGratis - Kanada basis kaart (Engels of Frans)",
	"%geo-select": "Kies",
	"%geo-labelselect": "Gaan die element te kies op die kaart",
