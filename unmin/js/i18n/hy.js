...
var ind = {
	...
	"%back": "Վերադառնալ",
	"%cancel": "Վերացնել",
	"%new-win": " (Բացվելու է նոր պատուհանի մեջ)",
	"%min-ago": "րոպե առաջ",
	...
	"%arch-pg": "Սույն վեբ կայքի պահոցավորված ցանցին վրայ ենք.",
	/* Menu bar */
	"%sm-hlp": "(Բացել ենթացանկը հետ մտնում բանալին եւ փակ է փախչել բանալին)",
	/* Tabbed interface */
	"%tab-rot": {
	...
	"%prog-bar": "օգտագործեք ձախ եւ աջ սլաքների բանալիները շարժվել եւ փաթաթելու լրատվամիջոցների առաջընթացը",
	"%no-video": "Ձեր բրաուզերը չի ունենալու հնարավորությունները խաղալ այս տեսանյութը, խնդրում ենք ծանոթանալ ստորեւ տեսանյութը",
	"%pos": "Ներկայիս պաշտոնը:",
	"%perc": "Նվագարկումը տոկոսը:",
	"%dur": "Ընդհանուր ժամանակը:",
	"%buff": "Սահմանել բուֆեր:",
	/* Share widget */
	"%fav": "հովանավորյալ",
	"%email": "Էլեկտրոնային փոստ",
	"%shr-txt": "Կիսում այս էջը",
	"%shr-hnt": " հետ {s} ",
	"%shr-email-sub": "Հետաքրքիր էջ",
	"%shr-email-bd": "Ես մտածեցի, որ դուք կարող եք գտնել այս էջը հետաքրքիր:\n{t} ({u})",
	"%shr-fav-ttl": "(Գրանցել այս էջն)",
	"%shr-man": "Փակցնելուց առաջ խնդրում ենք փակիր այս երկխոսությունը եւ սեղմել Ctrl-D: Ինչպես Գրանցել այս էջն իմ.",
	"%shr-all": "Ցուցադրել բոլորը ({n})",
	"%shr-all-ttl": "Բոլոր ճանապարհները կայքեր",
	...
	"%mnths": ["Հունվար", "Փետրվար", "Մարտ", "Ապրիլ", "Մայիս", "Հունիս", "Հուլիս", "Օգոստոս", "Սեպտեմբեր", "Հոկտեմբեր", "Նոյեմբեր", "Դեկտեմբեր"],
	"%cal": "Օրացույց",
	"%currDay": "(Ընթացիկ օր)",
	...
	"%nxtMnth": "Հաջորդ ամիս: ",
	/* Slideout */
	"%show-toc": "Ցույց տալ բովանդակությունը",
	"%hide-toc": "Թաքցնել բովանդակությունը",
	"%toc": "Բովանդակություն",
	/* Lightbox */
	...
	/* Geomap */
	"%geo-mapcontrol": "Քարտեզ հսկողություն",
	"%geo-zoomin": "Խոշորացնել",
	"%geo-zoomout": "Փոքրացնել",
	"%geo-zoomworld": "Մեծացնել քարտեզը չափը",
	"%geo-zoomfeature": "Մանրացնել տարր է",
	"%geo-scaleline": "Քարտեզ սանդղակ",
	"%geo-mouseposition": "Լայնության եւ երկայնությունը մկնիկի կուրսորը",
	"%geo-ariamap": "Քարտեզ օբյեկտի. Նկարագրերը եւ քարտեզը հատկանիշները են ստորեւ բերված աղյուսակում.",
	"%geo-accessibilize": "<strong>Ստեղնաշարի գրանցվածները:</strong> Երբ քարտեզը ուշադրության կենտրոնում, օգտագործեք սլաքը բանալիները համահայկական քարտեզի վրա եւ այն, եւ գումարած մինուս բանալին վրա, այն մեծացնելու. Սլաքը բանալիներ չեն համահայկական քարտեզը երբ Մանրացնել է քարտեզ չափով.",
	"%geo-accessibilizetitle": "Հրահանգներ: Նավիգացիոն քարտեզ",
	"%geo-togglelayer": "Ցուցադրման կամ թաքցնել շերտը",
	"%geo-hiddenlayer": "Այս շերտի այժմ թաքնված.",
	...
	"%geo-attributiontitle": "GeoGratis - Կանադա բազա քարտեզ (անգլերեն կամ ֆրանսերեն միայն)",
	"%geo-select": "Ընտրել",
	"%geo-labelselect": "Ստուգեք ընտրել տարրը քարտեզի վրա",
